...
class RepresentationModel(nn.Module):
    def __init__(self, cut_size, dataset, compressor=None, compression_parameter=None, compression_type=None, num_samples=None):
        ...
        if dataset == 'cifar10':
            ...
            self.resnet18.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=0, bias=False)
            self.resnet18.maxpool = nn.Identity()
            self.resnet18.fc = nn.Linear(512 * BasicBlock.expansion, cut_size)
...
class ResNetSplitNN(SplitNN):
    def __init__(self, cut_size, aggregation_mechanism, num_classes, private_labels,
        ...
        representation_model_parameters = cut_size, dataset, compressor, compression_parameter, compression_type, num_samples
